    ...
    <section class="bg-canvas-color h-screen overflow-hidden">
      ...
      >
        ...
        <div class="mt-3 text-center">
          ...
          <div class="mt-2 w-full flex items-center justify-center py-1 border-2 border-black rounded-xl cursor-pointer">
            <span
              ><svg
                class="svg"
                width="18"
          ...
          <div class="mt-5 font-medium">
            Already Have an Account? <nuxt-link to="/login"><span class="text-primary-color">Login</span></nuxt-link>
          </div>
        </div>
      </div>
    </section>
