...
<template>
  <div class="addons pb-14">
    ...
    <div class="border-b pb-7 mb-10" v-if="checkAddedAddons()">
      ...
      <EditorSidebarSectionAddonsSignoff v-if="data.addons.signoff" />
      <EditorSidebarSectionAddonsDisclaimer v-if="data.addons.disclaimer" />
      <EditorSidebarSectionAddonsSocial v-if="data.addons.social" />
      <EditorSidebarSectionAddonsGreenMessage v-if="data.addons.greenMessage" />
      <EditorSidebarSectionAddonsVideoMeeting v-if="data.addons.videoMeeting" />
      <EditorSidebarSectionAddonsCta v-if="data.addons.cta" />
    </div>
    <!-- Available Addons-->
