...
<template>
  ...
  >
    ...
    <div class="flex md:hidden items-center justify-center cursor-pointer" @click="toggleNav" ref="mobileNav">
      <svg
        clip-rule="evenodd"
        fill-rule="evenodd"
  ...
  <!-- Mobile Nav -->
  <div class="fixed top-0 left-0 w-full h-full bg-[#ffffff83] backdrop-blur z-30" v-if="showNav"></div>
  <transition name="nav">
    <template v-if="showNav" ref="mobileNav">
      ...
      >
        ...
        <div class="px-5 py-5 border-b">
          <div class="py-3">
            <nuxt-link to="/settings">
              <div class="flex items-center  hover:text-primary-color transition-all duration-300 ease-in-out">
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
          ...
          <div class="py-2">
            <div class="flex items-center cursor-pointer hover:text-primary-color transition-all duration-300 ease-in-out">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
